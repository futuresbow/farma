    ...
    <div class="inner">
        ...
        <div class="box">
            ...
            <div class="item">
                ...
                <div class="cart-container nagykosar" id="nagykosar">
        ...
        <div class="box">
            ...
            <div class="item" id="szemelyesadatok">
				...
				<?php if(!is_object($f)): ?>
				<table align="center" cellspacing=10 cellpadding=10 style="display:none"><tr>
       ...
       <input type="hidden" id="regtipus" name="f[regtipus]" value="" />
		...
		<?php endif; ?>
                ...
                <div class="input-line">
                 ...
                 <div class="input-line jelszosor" style="display:<?= isset($p['jelszocb'])?'block':'none';?>" >
                    <div class="input-container">
