<?php if(!empty($rendeles->termekLista)) : ?>					
                    ...
                    <?php endforeach ; ?>
                        ...
                        <tr>
                            ...
                            <td colspan="3" class="single-line"><?= __f('ÁFA-tartalom');?></td>
		...
		<a href="javascript:void(0);" onclick="window.location.href='?kosarurites=1'" title="<?= __f('Kosár kiűrítése');?>" style="float:right">
