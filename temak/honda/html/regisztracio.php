        ...
        <div class="box">
			<div class="item">
                ...
                <div class="input-line jelszosor" >
                    ...
                    <div class="input-container">
                        <label for="" class="important"><?= __f('Jelszó újra');?></label>
            ...
            <div class="item">
                ...
                <div class="input-line">
                    <div class="checkbox-container">
                        ...
                        <div class="ch-line">
                            <input id="aszf" type="checkbox" value="1" >
                            <label for="aszf" class="important"><?= __f('Elfogasom az <a title="aszf" href="<?= base_url(); ?>aszf" target="_blank">Általános Szerződési Feltételeket</a>.');?></label>
                            <div class="error-msg"><?= __f('Hiba!');?></div>
                        </div>
                    </div>
                </div>
...
<script>
	var Validalas = function() {
		...
		this.regisztacioEllenorzes = function() {
			...
			if($('#aszf').prop("checked")!=true) {
				hiba = true;
				$('#aszf').parent().addClass("error");
			} else {
				$('#aszf').parent().removeClass("error");
