                ...
                <div class="form-line">
                    <div class="input-container">
                        <label for="" class="">Kupon felhasználása</label>
                            ...
                            <input type="text" name="kuponkod" id="kuponkod" onchange="siteJs.kuponvizsgalat()" placeholder="Ha rendelkezik kuponkóddal, itt megadhatja." >                                                                                                                
                        
                        <div class="error-msg">Hiba!</div>
                    </div> 
                    
                    <div class="input-container price-container kuponkedvezmenyosszeg">
       ...
       <input type="hidden" id="regtipus" name="f[regtipus]" value="" />
		...
		<?php endif; ?>
            ...
            <div class="form-elements">
                ...
                <div class="form-line">
                    <div class="input-container">
                        ...
                        <input maxlength="8" class="req" type="text" <?php if(beallitasOlvasas('kosar_betus_iranyitoszam')!='1'):?>onkeyup="this.value=parseInt(this.value);if(isNaN(this.value))this.value=''"<?php endif; ?> name="v[szaml_irszam]" value="<?= @$v->szaml_irszam;?>">
                        <div class="error-msg"><?= __f('A mező kitöltése kötelező');?></div>
                    </div>
                    <div class="input-container">
            ...
            <div class="form-elements">
                ...
                <div style="display:<?= isset($p['szalszamlcb'])?'none':'block';?>;" id="szalszamldiv"> <!-- display:block;, if unchecked -->
                    ...
                    <div class="form-line">
                        <div class="input-container">
                            <label for="" class="important">Irányítószám</label>
                            <input maxlength="8" type="text" name="v[szall_irszam]" <?php if(beallitasOlvasas('kosar_betus_iranyitoszam')!='1'):?>onkeyup="this.value=parseInt(this.value);if(isNaN(this.value))this.value=''"<?php endif; ?> value="<?= @$v->szall_irszam;?>">
                            <div class="error-msg"><?= __f('A mező kitöltése kötelező');?></div>
                        </div>
                        <div class="input-container">
                            <label for="" class="important">Település</label>
            ...
            <div class="form-elements">
                ...
                <div class="form-line">
                    <div class="checkbox-container">						<?php if(!$f): // csak akkor, ha nem belépett felhasználó... ?>
                        <div class="ch-line">
