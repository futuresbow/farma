...
class Post_admin extends MY_Modul{
	...
	public function lista() {
		...
		$tablazat->adatBeallitas('megjelenitettMezok', array('kep' => '', 'cim' => 'Cím', 'nyelv' => 'nyelv', 'kategoriak' => 'Kategóriák' ,  'szerkesztes' => 'Szerkesztés' ));
	...
	public function kategorialista() {
		...
		$tablazat->adatBeallitas('megjelenitettMezok', array('kategorianev' => 'Név', 'nyelv' => 'nyelv',  'szerkesztes' => 'Szerkesztés'));
